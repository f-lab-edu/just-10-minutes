...
public interface UserMapper {
    ...
    @Insert("INSERT INTO users_table (login_id, password, phone, address, role, points)" +
            "VALUES (#{loginId}, #{password}, #{phone}, #{address}, #{role}, #{points})")
    ...
    @Update("UPDATE users_table SET points = #{updatePoints} WHERE login_id = #{loginId}")
